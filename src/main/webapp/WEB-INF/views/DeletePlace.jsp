				...
				<div id="nav_con">
					<div class="top_nav">
						...
						<ul class="menu">
							...
							<li><a
								href="http://localhost:8080/facebook/log/bestplace2">Best Place</a></li>
							<li><a rel="nofollow"
		...
		<table id="mytable" class="table table-striped"
			...
			<thead>
				...
				<th style="padding-right: 62px;">No.</th>
					...
					<th style="padding-right: 62px;">Place Photo</th>
			...
			<tbody id="tbody" align="left" style="">
				...
				<c:forEach var="bestplace" items="${BestPlace}">
					<tr id="eee">
						...
						<td><a href="http://localhost:8080/facebook/log/delete?id=${bestplace.id}">Delete</a></td>
					</tr>
				</c:forEach>
			</tbody>
		</table>
