...
<script type="text/javascript" async="" src="bsa.js"></script>
...
<li><a rel="nofollow"
					...
					<div id="container-1"
						...
						<div class="box"
							...
							<form id="searchform" action="log/findfriends"
								...
								<!--  	<a href="http://localhost:8080/facebook/log/findfriends" class="search_button" name="" type="submit"
			...
			style="position: absolute; left: 610px; top: 360px;" type="submit">Submit</button>-->
								</div>
							</form>
						</div>
						...
						<div class="button-wrapper-large"
							...
							<button id="birthday2" class="a-btn">
								<span class="a-btn-text"><a
									href="http://localhost:8080/facebook/log/friendlocale">Friends'
										Location</a></span> <span class="a-btn-slide-text">Check It</span> <span
									class="a-btn-icon-right"><span></span></span>
							</button>
							<br> <br> <br> <br> <br>
							<button id="school2" class="a-btn">
								<span class="a-btn-text"><a
									href="http://localhost:8080/facebook/log/frienddevices">Other
										Information</a></span> <span class="a-btn-slide-text">Check It</span> <span
									class="a-btn-icon-right"><span></span></span>
							</button>
							<br> <br> <br> <br> <br>
							<button id="id2" class="a-btn">
								<span class="a-btn-text"><a
									href="http://localhost:8080/facebook/log/friends">Friends'
										ID</a></span> <span class="a-btn-slide-text">Check It</span> <span
									class="a-btn-icon-right"><span></span></span>
							</button>
							<br> <br> <br> <br> <br>
							<button id="photo2" class="a-btn">
								<span class="a-btn-text"><a
									href="http://localhost:8080/facebook/log/friendphoto">Friends'
										Photo</a></span> <span class="a-btn-slide-text">Check It</span> <span
									class="a-btn-icon-right"><span></span></span>
							</button>
							<br> <br> <br> <br> <br>
							<button id="home2" class="a-btn">
								<span class="a-btn-text"><a
									href="http://localhost:8080/facebook/log/friendhome">Friends'
										Homepage</a></span> <span class="a-btn-slide-text">Check It</span> <span
									class="a-btn-icon-right"><span></span></span>
							</button>
						</div>
