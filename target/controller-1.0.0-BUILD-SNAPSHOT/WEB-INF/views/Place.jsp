...
<title>My JSP 'Place.jsp' starting page</title>
...
<li><a rel="nofollow"
	...
	<div class="box">
		<form id="searchform" action="log/test" method="post" role="search">
			<div style="position: absolute; left: 202px; top: 262px;">
				<input id="s" type="text" name="lon" class="input_box"
					value="Lontitude"
					
					style="color: #afb2b9; margin-right: 22px;"> <input id="s"
					type="text" name="lat" class="input_box" value="Latitude"
					
					style="color: #afb2b9; margin-right: 22px;"> <input id="s"
					type="text" name="type" class="input_box" value="TypeofPlace"
					
					style="color: #afb2b9; margin-right: 22px;"> <input id="s"
					type="text" name="scope" class="input_box" value="Scope"
					
					style="color: #afb2b9;">
				<button class="search_button" name="" type="submit"
					style="width: 35px; height: 34px; background: url(resources/img/bg_search_button.png) left top no-repeat; border: none; cursor: pointer; vertical-align: middle; text-indent: -90000px; -webkit-box-shadow: 1px 1px 1px #4b4b4b; position: absolute; right: -50; top: -5px;"></button>
			</div>
		</form>
	</div>
	...
	<div class="tab_box">
		<table id="mytable" class="table table-striped"
			style="font-size: 21px; height: 22px; width: 860px; position: absolute; left: 230px; font-family: Open Sans; top: 350px; color: #86888D;">
			<thead>
				<tr>
					<th style="padding-right: 62px;">Longtitude</th>
