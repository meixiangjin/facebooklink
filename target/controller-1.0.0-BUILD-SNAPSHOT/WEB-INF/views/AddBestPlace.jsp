...
<body>
				...
				<div id="nav_con">
					<div class="top_nav">
						...
						<ul class="menu">
							...
							<li><a rel="nofollow" href="http://localhost:8080/facebook/log/bestplace2">Best Place</a></li>
							<li><a href="http://localhost:8080/facebook/log/deleting">Delete Place</a></li>
	...
	<form id="searchform" action="log/adding" method="post" role="search">
		<div class="control-group info"
			style="position: absolute; left: 332px; width: 666px">
		  <label class="control-label" for="inputInfo"
				style="font-size: 20px; font-family: &amp; amp; quot; Open Sans&amp;amp; quot;; color: #505f68;">No.</label>
			<div class="controls">
				<input type="text" name="no" id="inputInfo"
					style="font-size: 20px; font-family: &amp; amp; quot; Open Sans&amp;amp; quot;; width: 666px; height: 30px; color: #505f68;">
			</div>



			<label class="control-label" for="inputInfo"
				style="font-size: 20px; font-family: &amp; amp; quot; Open Sans&amp;amp; quot;; color: #505f68;">Lontitude</label>
			<div class="controls">
				<input type="text" name="lontitude" id="inputInfo"
					style="font-size: 20px; font-family: &amp; amp; quot; Open Sans&amp;amp; quot;; color: #505f68; width: 666px; height: 30px;">
			</div>



			<label class="control-label" for="inputInfo"
				style="font-size: 20px; font-family: &amp; amp; quot; Open Sans&amp;amp; quot;; color: #505f68;">Latitude</label>
			<div class="controls">
				<input type="text" name="latitude" id="inputInfo"
					style="font-size: 20px; font-family: &amp; amp; quot; Open Sans&amp;amp; quot;; width: 666px; height: 30px; color: #505f68;">
			</div>

			<label class="control-label" for="inputInfo"
				style="font-size: 20px; font-family: &amp; amp; quot; Open Sans&amp;amp; quot;; color: #505f68;">Place Photo</label>
			<div class="controls">
				<input type="text" name="type" id="inputInfo"
					style="font-size: 20px; font-family: &amp; amp; quot; Open Sans&amp;amp; quot;; width: 666px; height: 30px; color: #505f68;">
			</div>
			<label class="control-label" for="inputInfo"
				style="font-size: 20px; font-family: &amp; amp; quot; Open Sans&amp;amp; quot;; color: #505f68;">Place
				Name</label>
			<div class="controls">
				<input type="text" name="name" id="inputInfo"
					style="font-size: 20px; font-family: &amp; amp; quot; Open Sans&amp;amp; quot;; width: 666px; height: 30px; color: #505f68;">
			</div>

			<label class="control-label" for="inputInfo"
				style="font-size: 20px; font-family: &amp; amp; quot; Open Sans&amp;amp; quot;; color: #505f68;">Address</label>
			<div class="controls">
				<input type="text" name="address" id="inputInfo"
					style="font-size: 20px; font-family: &amp; amp; quot; Open Sans&amp;amp; quot;; width: 666px; height: 30px; color: #505f68;">
			</div>
		</div>
		...
		<button class="btn btn-large" type="submit"
			style="position: absolute; left: 610px; top: 660px;" type="submit">Submit</button>
